...
class UiSchemaResourceFailuresTest {
	...
	@Test
	void createOrUpdateUiSchemaInvalidMunicipalityId() throws Exception {
		...
		assertThat(response.getViolations())
			.extracting(Violation::getField, Violation::getMessage)
			.containsExactly(tuple("createOrUpdateUiSchema.municipalityId", "not a valid municipality ID"));
